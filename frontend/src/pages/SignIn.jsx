...
export default function SignIn() {
  ...
  /* live validate on every keystroke for touched fields */
  const validate = (data) => ({
            ...
            <div className="auth-input-wrap">
              ...
              {fieldState('email') === 'success' && (
                <span className="auth-input-check">
                  <svg viewBox="0 0 16 16" fill="none"><path d="M3 8l4 4 6-7" stroke="#4ade80" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </span>
              )}
            </div>
